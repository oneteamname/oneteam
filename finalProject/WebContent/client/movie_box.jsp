...
<div class="row">
	<c:set var="Rankcount" value="1"/>
	<c:forEach var="dtoList" items="${boxmovieList}">
		
		<div class="col-sm-4 col-lg-4 col-md-4">
			<div class="thumbnail">
					<img src="${pageContext.request.contextPath}/poster/${dtoList.file_directory}/${dtoList.poster}" style="max-height: 450px;">
				<div class="caption">
					<h4 class="pull-right"><img src="${pageContext.request.contextPath}/img/${Rankcount }.png" width="60px"></h4>
		...
		<!-- 영화 상세정보 모달 팝업 -->
		<div class="modal fade" id="${dtoList.num }" tabindex="-1"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<c:forEach var="dto" items="${boxmovieList}">
		                                    ...
		                                    <!-- <div>-->
		                                        <tr>
		                                           ...
		                                           <c:if test="${loginId.id == replydto.id}">
		                                              ...
		                                              <input type="button" name="delete" value="삭제" onclick="location.href='admin_movie_replyDelete.do?num=${replydto.num}&mode=box'"></td>
		                                           </c:if>
		                                           <c:if test="${loginId.id != replydto.id}">
