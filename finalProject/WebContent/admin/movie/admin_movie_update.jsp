   ...
   <table border="2" class="outline" width="800" align="center">
      ...
      <tr>
         ...
         <td align="left"><input type="text" name="actor"
            value="${movieDTO.actor }"> 입력 예시-- 하**,양**,조**</td>
      </tr>
      <tr>
         <th class="m2">*장르</th>
...
<%--          <c:forEach var="grade" items="${gradeList}">
            ...
            <option value="${movieDTO.grade}" selected>${movieDTO.grade}</option>
               <c:if test="${movieDTO.grade!=0 }"><option value="0">0</option></c:if>
               <c:if test="${movieDTO.grade!=12 }"><option value="12">12</option></c:if>
               <c:if test="${movieDTO.grade!=15 }"><option value="15">15</option></c:if>
               <c:if test="${movieDTO.grade!=18 }"><option value="18">18</option></c:if>
               <c:if test="${movieDTO.grade!=19 }"><option value="19">19</option></c:if>
         </select></td>
      </tr>
      ...
      <tr>
         ...
         <td align="left"><input type="text" name="country"
            value="${movieDTO.country }"></td>
      </tr>
      <tr>
         <th class="m2">*개봉일</th>
         <td align="left">
            <form>
               <input type="text" id="txtDate" value="${movieDTO.opendate }" name="opendate"
      ...
      <tr>
         <th class="m2">*줄거리</th>
         <td align="left"><textarea name="movie_info" rows="15" cols="80">${movieDTO.movie_info }</textarea></td>
      </tr>
      <tr>
